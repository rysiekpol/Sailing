	...
	<main>
		...
		<article>
			...
			<div class="contact">
				...
				<p>Masz pytanie dotyczące żagli? A może chciałbyś zaproponować dodanie nowej treści na stronę. Zapraszamy do kontaktu!</p>
				<p>Kontakt mailowy: <a href="https://gmail.com" target="_blank">sailing@contact.com</a></p>
				<p>Facebook: <a href="https://facebook.com" target="_blank">sailing.com - żeglarstwo</a></p>
				<p>Instagram: <a href="https://instagram.com" target="_blank">@sailing.com</a></p>
				<p>Kontakt telefoniczny: <a>+58 556 12 78</a></p>

				<figure>
					<img src="img/wiatr.jpg" alt="Wind"/>
					<figcaption>
						Życzymy sprzyjających wiatrów!
					</figcaption>
				</figure>
			</div>
