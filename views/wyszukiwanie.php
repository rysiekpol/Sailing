...
<body>
    ...
    <h3 style="text-align:center;color:#e07a5f">Wyszukiwanie zdjęć</h3>
    <div style="text-align:center;">
         <input type="text" id="search" style="text-align:center;" id="search" placeholder="Wyszukaj zdjęcie" />
    </div>
    <div id="searchGalery"></div>
