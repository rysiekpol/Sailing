...
<body>
    ...
    <h3 style="text-align:center">Zapisane zdjęcia - <a href="galeria-zdjec" style="text-decoration:none;color:#e07a5f">Galeria zdjęć</a></h3>

    <div id="databaseGalery">
        <?php
        require_once 'pagingSaved.php';       
        ?>
    </div>
